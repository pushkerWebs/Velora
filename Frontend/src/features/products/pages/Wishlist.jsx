        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/65 backdrop-blur-sm">
                <motion.div
                    ...
                    className="bg-white border border-[#E5E5E5] rounded-2xl shadow-2xl max-w-[800px] w-full overflow-hidden flex flex-col md:flex-row relative"
                >
                    <button
                        onClick={onClose}
                        className="absolute top-4 right-4 z-20 w-8 h-8 rounded-full bg-white/90 border border-[#E5E5E5] text-black font-bold flex items-center justify-center hover:bg-black hover:text-white transition-all cursor-pointer shadow-sm text-xs"
                    >
                        ✕
                    </button>

                    <div className="w-full md:w-1/2 aspect-[4/5] bg-[#F4F3F3] overflow-hidden relative">
                        {primaryImage ? (
                            <img src={primaryImage} alt={title} className="w-full h-full object-cover" />
                        ) : (
                            <div className="w-full h-full flex items-center justify-center text-gray-400">No Image</div>
                        )}
                        <span className="absolute top-4 left-4 text-[9px] font-bold uppercase tracking-[0.2em] bg-black/80 text-white px-2.5 py-1 rounded-sm">
                            {category}
                        </span>
                    </div>
                    ...
                    <div className="w-full md:w-1/2 p-6 sm:p-8 flex flex-col justify-between">
                        <div className="flex flex-col gap-3">
                            ...
                            <h2 style={{ fontFamily: "'Montserrat', sans-serif" }} className="text-lg sm:text-xl font-bold uppercase text-[#111] leading-tight">
                                {title}
                            </h2>
                            <div className="flex items-center gap-3">
                                <span className="text-lg font-bold text-[#111]">{formattedVal}</span>
                                ...
                                <div className="flex gap-2">
                                    {sizes.map((s) => (
                                        <button
                                            ...
                                            className={`w-9 h-9 rounded text-[11px] font-bold uppercase transition-all cursor-pointer border ${selectedSize === s ? 'bg-[#111] text-white border-[#111]' : 'bg-[#F9F9F9] text-[#111] border-[#E5E5E5] hover:border-[#111]'}`}
                                        >
                                            {s}
                                        </button>
                                    ))}
                        ...
                        <div className="flex flex-col gap-2.5 mt-6">
                            <button
                                ...
                                className="w-full bg-[#111111] text-white text-[10px] font-bold uppercase tracking-[0.18em] py-3.5 rounded-full hover:bg-black transition-all cursor-pointer shadow-sm disabled:opacity-50"
                            >
                                Move to Bag ({selectedSize}) →
                            </button>
                            <Link
                                to={`/product/${product._id}`}
                                className="text-center text-[10px] font-bold uppercase tracking-[0.14em] text-[#666] hover:text-black transition-colors"
                            >
...
export default function Wishlist() {
    ...
    const totalEstimatedValue = wishlistProducts.reduce((acc, p) => acc + (p.price?.amount || 0), 0)
    ...
    return (
        ...
        >
            ...
            <div className="max-w-[1440px] mx-auto w-full px-4 sm:px-6 lg:px-12 pt-20 sm:pt-24 pb-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[#E5E5E5] pb-5">
                    <div>
                        <h1
                            ...
                            className="text-[26px] sm:text-[34px] font-bold uppercase tracking-[0.1em] text-[#111111]"
                        >
                            WISHLIST
                        </h1>
                    ...
                    <div className="flex items-center gap-3">
                        {wishlistProducts.length > 0 && (
                            <button
                                ...
                                className="text-[10px] font-bold uppercase tracking-[0.16em] text-[#666] hover:text-red-600 transition-colors px-4 py-2 rounded-full border border-[#E5E5E5] bg-white cursor-pointer"
                            >
                                Clear All
                            </button>
                        )}
                        <Link
                            to="/products"
                            className="bg-[#111111] text-[#FAF9F6] hover:bg-black text-[10px] font-bold uppercase tracking-[0.2em] px-6 py-2.5 rounded-full transition-all cursor-pointer shrink-0 shadow-xs"
                        >
                            Explore Catalogue →
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center gap-2 pt-4 overflow-x-auto scrollbar-none">
                        {availableCategories.map((cat) => (
                            <button
                                ...
                                className={`px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-[0.14em] transition-all cursor-pointer whitespace-nowrap border ${activeFilter === cat ? 'bg-[#111] text-white border-[#111]' : 'bg-white text-[#555] border-[#E5E5E5] hover:border-[#111]'}`}
                            >
            ...
            {/* ── Main Content Area ── */}
            <main className="flex-1 max-w-[1440px] mx-auto w-full px-4 sm:px-6 lg:px-12 py-6 pb-28 lg:pb-20">
                {loading ? (
                    /* Loading Skeleton */
                    ...
                    <motion.div
                        ...
                        className="flex flex-col items-center justify-center py-20 text-center gap-5 max-w-md mx-auto px-4"
                    >
                        ...
                        <div>
                            <h2
                                style={{ fontFamily: "'Montserrat', sans-serif" }}
                                className="text-[20px] sm:text-[22px] font-bold uppercase text-[#111111] tracking-wider mb-1.5"
                            >
                        ...
                        <div className="flex flex-wrap justify-center gap-2 my-1">
                            <Link to="/jeans" className="bg-white border border-[#E5E5E5] text-[#111] text-[10px] font-bold uppercase tracking-[0.14em] px-4 py-2 rounded-full hover:border-[#111] transition-all">
                                Jeans →
                            </Link>
                            <Link to="/shirts" className="bg-white border border-[#E5E5E5] text-[#111] text-[10px] font-bold uppercase tracking-[0.14em] px-4 py-2 rounded-full hover:border-[#111] transition-all">
                                Shirts →
                            </Link>
                            <Link to="/t-shirts" className="bg-white border border-[#E5E5E5] text-[#111] text-[10px] font-bold uppercase tracking-[0.14em] px-4 py-2 rounded-full hover:border-[#111] transition-all">
                                T-Shirts →
                            </Link>
                        </div>
                        ...
                        <Link
                            to="/products"
                            className="bg-[#111111] text-white text-[10px] font-bold uppercase tracking-[0.2em] px-8 py-3 rounded-full hover:bg-black transition-all text-center shadow-xs mt-1"
                        >
                            Explore All Products
                        </Link>
                    </motion.div>
                ) : (
                    /* ── Active Wishlist View: Zara/COS Clean Edge Product Cards Grid (75%) + Summary (25%) ── */
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
                                ...
                                <AnimatePresence mode="popLayout">
                                    {filteredProducts.map((product, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                {/* 4:5 Image Box (Frameless Clean Look) */}
                                                <div className="relative aspect-[4/5] rounded-xl overflow-hidden bg-[#F4F3F3] border border-black/5 block group/img mb-3">
                                                    {primaryImage ? (
                                                        <>
                                                            <img
                                                                src={primaryImage}
                                                    ...
                                                    {/* Top Left Tag */}
                                                    <span className="absolute top-3 left-3 text-[9px] font-bold uppercase tracking-[0.16em] bg-black/75 text-white px-2.5 py-0.5 rounded-sm backdrop-blur-xs">
                                                        {category}
                                                    </span>
                                                    ...
                                                    <button
                                                        ...
                                                        className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/90 hover:bg-white text-red-500 shadow-sm flex items-center justify-center transition-transform hover:scale-110 cursor-pointer"
                                                    ...
                                                    <button
                                                        ...
                                                        className="absolute bottom-3 left-3 right-3 bg-white/95 backdrop-blur-md text-[#111] text-[9px] font-bold uppercase tracking-[0.18em] py-2 rounded-full opacity-0 group-hover/img:opacity-100 transition-all duration-300 hover:bg-black hover:text-white shadow-sm cursor-pointer text-center"
                                                    >
                                                        Quick View
                                                    </button>
                                                </div>
                                                ...
                                                <div className="flex flex-col gap-0.5 mb-3 px-0.5">
                                                    <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#888]">VELORA</span>
                                                    <Link
                                                        to={`/product/${product._id}`}
                                                        style={{ fontFamily: "'Montserrat', sans-serif" }}
                                                        className="text-[13px] font-bold text-[#111111] tracking-tight line-clamp-1 hover:opacity-70 transition-opacity"
                                                    >
                                                        {title}
                                                    </Link>
                                                    <div className="flex items-center justify-between mt-1">
                                                        <span className="text-[14px] font-extrabold text-[#111111]">{formattedVal}</span>
                                                        <span className="text-[9px] font-bold uppercase text-[#065F46] bg-[#065F46]/10 px-2 py-0.5 rounded-sm">
                                                            In Stock
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <button
                                                    ...
                                                    className="w-full bg-[#111111] hover:bg-black text-white text-[10px] font-bold uppercase tracking-[0.16em] py-3 rounded-full transition-all cursor-pointer shadow-xs disabled:opacity-50 active:scale-98"
                                                >
                        ...
                        <div className="lg:col-span-3">
                            <div className="bg-white rounded-2xl border border-[#E5E5E5] p-5 sm:p-6 sticky top-24 flex flex-col gap-4 shadow-xs">
                                <div className="border-b border-[#E5E5E5] pb-3">
                                    <h2
                                        style={{ fontFamily: "'Montserrat', sans-serif" }}
                                        className="text-[13px] font-bold uppercase tracking-wider text-[#111111]"
                                    >
                                        WISHLIST SUMMARY
                                    </h2>
                                </div>
                                ...
                                <div className="flex flex-col gap-2.5 text-[12px]">
                                    ...
                                    <div className="border-t border-[#E5E5E5] pt-3 flex items-center justify-between">
                                        <span className="text-[11px] font-bold uppercase tracking-wider text-[#111111]">Estimated Total</span>
                                        <span className="text-[17px] font-extrabold text-[#111111]">
                                ...
                                <div className="pt-2">
                                    <motion.button
                                        ...
                                        className="w-full bg-[#111111] hover:bg-black text-white text-[10px] font-bold uppercase tracking-[0.18em] py-3.5 rounded-full shadow-xs transition-all cursor-pointer disabled:opacity-50"
                                    >
                                        Move All To Bag
                                    </motion.button>
                                </div>
                ...
                <div className="block lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-[#E5E5E5] px-4 py-3 shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
                    <div className="max-w-[1440px] mx-auto flex items-center justify-between gap-3">
                        ...
                        <motion.button
                            ...
                            onClick={handleMoveAllToBag}
                            disabled={cartLoading}
                            className="bg-[#111111] text-white text-[10px] font-bold uppercase tracking-[0.16em] px-6 py-3 rounded-full shadow-xs cursor-pointer flex-1 max-w-[200px] text-center disabled:opacity-50"
                        >
                            MOVE ALL TO BAG
                        </motion.button>
                    </div>
